...
(function () {
  ...
  style.textContent = [
    ...
    '  border-bottom: 1px solid var(--color-border-subtle, #f0ece6);',
    '}',
    '.a11y-panel__close {',
    '  background: none;',
    '  border: none;',
    ...
    '  border-top: 1px solid var(--color-border-subtle, #f0ece6);',
    '}',
    '.a11y-option__label {',
    '  font-size: 0.85rem;',
    '  color: var(--color-ink, #1a1a1a);',
    ...
    '  --color-ink-secondary: #5a5a5a !important;',
    '  --color-ink-muted: #999 !important;',
    '  --color-ink-hero: #1a1a1a !important;',
    '  --color-ink-hero-muted: #5a5a5a !important;',
    '  --color-ink-on-dark: #1a1a1a !important;',
    '  --color-ink-on-dark-muted: #5a5a5a !important;',
    '  --color-accent: #b8860b !important;',
    '  --color-accent-hover: #9a7209 !important;',
    '  --color-accent-subtle: rgba(184,134,11,0.08) !important;',
    '  --color-border: #e8e4de !important;',
    '  --color-border-subtle: #f0ece6 !important;',
    '  --color-focus: #4a7cb8 !important;',
    '  --color-divider: #ddd8d0 !important;',
    ...
    '  --color-ink-secondary: #a8a8a8 !important;',
    '  --color-ink-muted: #666 !important;',
    '  --color-ink-hero: #eae6e1 !important;',
    '  --color-ink-hero-muted: rgba(234,230,225,0.5) !important;',
    '  --color-ink-on-dark: #eae6e1 !important;',
    '  --color-ink-on-dark-muted: rgba(234,230,225,0.5) !important;',
    '  --color-accent: #d4a853 !important;',
    '  --color-accent-hover: #e0bc6a !important;',
    '  --color-accent-subtle: rgba(212,168,83,0.1) !important;',
    '  --color-border: #2a2a2a !important;',
    '  --color-border-subtle: #1f1f1f !important;',
    '  --color-focus: #7aa8d8 !important;',
    '  --color-divider: #2e2e2e !important;',
